...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projet_barriere1.0_slave.exe: ${OBJECTFILES}
	...
	avr-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projet_barriere1.0_slave ${OBJECTFILES} ${LDLIBSOPTIONS} -Os -Wl,--gc-sections -mmcu=atmega328p
...
${OBJECTDIR}/C_ESCLAVE.cpp.gch: C_ESCLAVE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../../Arduino/hardware/arduino/cores/arduino -I/../../../../../../Arduino/libraries/Servo -I/../../../../../../Arduino/libraries/Grove_LCD_RGB_Backlight_master -I/../../../../../../Arduino/libraries/Wire -I/../../../../../../Arduino/libraries/Wire/utility -I/../../../../../../Arduino/libraries/SoftwareSerial -MMD -MP -MF "$@.d" -o "$@" C_ESCLAVE.cpp
